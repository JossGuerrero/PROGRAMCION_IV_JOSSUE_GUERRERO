...
class OrderItem {
  ...
  factory OrderItem.fromJson(Map j) => OrderItem(
    id: j['id'] as int,
    productId: (j['product'] as Map)['id'] as int,
    productName: (j['product'] as Map)['name'] as String,
...
class Order {
  ...
  factory Order.fromJson(Map j) => Order(
    ...
    items: (j['items'] as List)
        .map((e) => OrderItem.fromJson(e as Map))
        .toList(),
...
class PaginatedOrders {
  ...
  factory PaginatedOrders.fromJson(Map j) => PaginatedOrders(
    count: j['count'] as int,
    next: j['next'] as String?,
    results: (j['results'] as List)
        .map((e) => Order.fromJson(e as Map))
        .toList(),
  );
}
