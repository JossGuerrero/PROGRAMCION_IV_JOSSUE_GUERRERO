...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/', builder: (_, __) => const _PlaceholderScreen('Home — M5')),
      GoRoute(path: '/catalog', builder: (_, __) => const _PlaceholderScreen('Catálogo — M5')),
      GoRoute(path: '/product/:id', builder: (_, __) => const _PlaceholderScreen('Detalle — M5')),
