...
class PaginatedUsers {
  ...
  factory PaginatedUsers.fromJson(Map j) => PaginatedUsers(
        count: j['count'] as int,
        next: j['next'] as String?,
        results: (j['results'] as List).map((e) => User.fromJson(e as Map)).toList(),
      );
}

abstract class UserRemoteDatasource {
  Future<PaginatedUsers> getUsers({String? search, bool? isStaff, bool? isActive});
  Future<User> createUser(Map payload);
  Future<User> updateUser(int id, Map payload);
...
class UserRemoteDatasourceImpl implements UserRemoteDatasource {
  ...
  Future<PaginatedUsers> getUsers({String? search, bool? isStaff, bool? isActive}) async {
    try {
      ...
      return PaginatedUsers.fromJson(res.data as Map);
  ...
  @override
  Future<User> createUser(Map payload) async {
    try {
  ...
  @override
  Future<User> updateUser(int id, Map payload) async {
    try {
