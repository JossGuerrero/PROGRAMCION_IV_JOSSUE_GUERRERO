...
abstract class ProductRemoteDatasource {
  ...
  Future<Product> createProduct(Map payload);
  Future<Product> updateProduct(int id, Map payload);
...
class ProductRemoteDatasourceImpl implements ProductRemoteDatasource {
  ...
  Future<PaginatedProducts> getProducts({
    ...
    try {
      ...
      return PaginatedProducts.fromJson(res.data as Map);
  ...
  @override
  Future<Product> createProduct(Map payload) async {
    try {
  ...
  @override
  Future<Product> updateProduct(int id, Map payload) async {
    try {
