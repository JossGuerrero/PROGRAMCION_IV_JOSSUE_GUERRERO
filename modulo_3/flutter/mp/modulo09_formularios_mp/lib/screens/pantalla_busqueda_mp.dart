...
class _PantallaBusquedaState extends State<PantallaBusqueda> {
  final _buses = [
    BusSSH(id:'1', nombre:'AV204',  ruta:'UIO ➔ GYE', capacidad:180, conductor:'Juan Pérez',   modelo:'Airbus A320',  clima:true,  favorito:true),
    BusSSH(id:'2', nombre:'LA1456', ruta:'UIO ➔ MIA', capacidad:160, conductor:'Carlos Ruiz',  modelo:'Boeing 737',   clima:true),
    BusSSH(id:'3', nombre:'EQ350',  ruta:'GYE ➔ MAD', capacidad:250, conductor:'Luis Gómez',   modelo:'Airbus A330',  clima:false),
    BusSSH(id:'4', nombre:'AV999',  ruta:'UIO ➔ BOG', capacidad:180, conductor:'Ana Torres',   modelo:'Boeing 737',   clima:false),
  ];
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: SearchBar(
              hintText: 'Buscar por vuelo, ruta o piloto...',
