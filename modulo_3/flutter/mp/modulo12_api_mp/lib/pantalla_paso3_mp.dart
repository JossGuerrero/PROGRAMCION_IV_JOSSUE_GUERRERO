...
class PantallaPaso3 extends StatelessWidget {
  ...
  Future<List<Vuelo>> _fetchVuelos() async {
    ...
    return lista
        .map((e) => VueloDto.fromJson(e as Map<String, dynamic>).toDomain())
        .toList();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paso 3 · Vuelos disponibles'),
        leading: BackButton(onPressed: () => context.go('/')),
      ),
      body: FutureBuilder<List<Vuelo>>(
        future: _fetchVuelos(),
