...
class PantallaPaso1 extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> _fetchViaje() async {
          ...
          builder: (context, snap) {
            ...
            return Padding(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Icon(Icons.flight, size: 48, color: Colors.green),
                  const SizedBox(height: 16),
                  Text('ID: ${viaje['id']}',
                      style: const TextStyle(fontSize: 14, color: Colors.grey)),
                  const SizedBox(height: 8),
                  Text(
                    viaje['title'] as String,
                  ...
                  Chip(
                    label: Text(
                      (viaje['completed'] as bool) ? 'Vuelo Aterrizado ✓' : 'En Vuelo',
                    ),
                    backgroundColor: (viaje['completed'] as bool)
                        ? Colors.green[100]
                        : Colors.orange[100],
                  ),
                ],
