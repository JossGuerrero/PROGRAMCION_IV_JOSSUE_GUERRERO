...
import 'package:modulo12_api_mp/pantalla_paso1_mp.dart';
import 'package:modulo12_api_mp/pantalla_paso1_users_mp.dart';
import 'package:modulo12_api_mp/pantalla_paso2_mp.dart';
import 'package:modulo12_api_mp/pantalla_paso2_users_mp.dart';
import 'package:modulo12_api_mp/pantalla_paso3_mp.dart';
  ...
  Widget build(BuildContext context) {
    const pasos = [
      _PasoInfo(
        ruta: '/paso1',
        titulo: 'Paso 1',
        subtitulo: 'Estado de vuelo (FutureBuilder crudo)',
        detalle: 'http.get() + FutureBuilder · Consulta un vuelo',
        icono: Icons.flight,
        color: Colors.blue,
      ),
       _PasoInfo(
        ruta: '/paso1users',
        titulo: 'Paso 1 Piloto',
        subtitulo: 'Mostrar un piloto',
        detalle: 'http.get() + FutureBuilder · API Tripulación',
        icono: Icons.badge,
      ...
      _PasoInfo(
        ...
        detalle: 'VueloDto.fromJson · lista de vuelos',
        icono: Icons.flight,
        color: Colors.green,
      ),
      _PasoInfo(
        ruta: '/paso2users',
        titulo: 'Paso 2 Tripulación',
        subtitulo: 'Mostrar pilotos',
        detalle: 'PilotoDto.fromJson · lista de pilotos',
        icono: Icons.badge,
      ...
      _PasoInfo(
        ...
        detalle: 'VueloDto · toDomain() · Vuelos disponibles',
