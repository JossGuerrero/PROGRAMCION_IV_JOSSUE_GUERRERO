    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        onDestinationSelected: (i) {
          switch (i) {
            case 0: context.go('/buses'); break;
            case 1: context.go('/metricas'); break;
            case 2: context.go('/ajustes'); break;
            case 3: context.go('/dashboard'); break;
          }
        },
        destinations: const [
          NavigationDestination(
            icon: Icon(Icons.flight_outlined), selectedIcon: Icon(Icons.flight),
            label: 'Vuelos',
          ),
          NavigationDestination(
