...
import 'package:modulo11_gorouter_mp/screens/pantallaservidoresfiltro_mp.dart';
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) {
        // Query parameters — /buses?soloWifi=true
        final soloWifi = state.uri.queryParameters['soloWifi'] == 'true';
        return PantallaBusesFiltro(soloWifi: soloWifi);
      },
    ),
    GoRoute(
      path:    '/buses/:id',
