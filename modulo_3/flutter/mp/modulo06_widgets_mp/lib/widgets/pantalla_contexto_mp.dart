        ...
        children: [
          ...
          _Seccion(
            ...
            items: [
              ...
              'Precisión GPS:        ${MediaQuery.devicePixelRatioOf(context).toStringAsFixed(3)}',
              'Orientación de Ruta:  ${MediaQuery.paddingOf(context).top}',
            ],
          ),
          const SizedBox(height: 16),

          // ── Colores del tema ───────────────────────────────────
          _Seccion(titulo: 'Colores de la Flota (colorScheme)', items: []),
          Wrap(
          ...
          // ── Tipografía del tema ────────────────────────────────
          _Seccion(titulo: 'Tipografía de Letreros (textTheme)', items: []),
